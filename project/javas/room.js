var roomheadache = {
    ...
    create: function (){
        ...
        player[3].width=64;
        player[3].height=65;
        var go = game.add.button(window.outerWidth-750,window.outerHeight-349,'go',goclick,this);
        var exit = game.add.button(window.outerWidth-1200,window.outerHeight-349,'exit',exitclick,this);
        var invite = game.add.button(window.outerWidth-425,window.outerHeight-349,'invite',goclick,this);
        var send = game.add.button(window.outerWidth-385,window.outerHeight-157,'send',goclick,this);
        var text = []; 
